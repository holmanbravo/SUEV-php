        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown"><a href="#"  class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-question-sign"></span>  Preguntas<span class="caret"></span></a><ul class="dropdown-menu">
                        ...
                        <li><a href="crearCursos.php"><span class="glyphicon glyphicon-home"></span>  Inicio</a></li>
                    </ul></li>
            </ul>
...
<div class="container">
    <div class="alert alert-success" role="alert">Ingrese la pregunta que desea crear, asociela a un curso y marque el punto correcto.</div>
    <form class="form-horizontal" id="commentForm" method="post" action="../controller/GuardarPreguntas.php">
        <fieldset>
            ...
            <p>
                ...
                <textarea id="enun" name="enunciado" class="form-control" rows="3" placeholder="What does SQL stand for?" required></textarea>
            </p>
            <p>
                <label for="pregunta1">Opcion 1</label>
                <input id="opcion1" name="opcion" type="radio" value="rbipeliculas"><input id="pregunta1" name="respuesta1" minlength="2" type="text" class="form-control" placeholder="Strong Question Language" required></>
            </p>
            <p>
                <label for="pregunta2">Opcion 2</label>
                <input id="opcion2" name="opcion" type="radio" value="rbipeliculas"><input id="pregunta2" name="respuesta2" minlength="2" type="text" class="form-control" placeholder="Structured Question Language" required></>
            </p>
            <p>
                <label for="pregunta3">Opcion 3</label>
                <input id="opcion3" name="opcion" type="radio" value="rbipeliculas"><input id="pregunta3" type="text" minlength="2" name="respuesta3" class="form-control" placeholder="Structured Query Language"  required></>
            </p>
            <p>
                <label for="pregunta4">Opcion 4</label>
                <input id="opcion4" name="opcion" type="radio" value="rbipeliculas"><input id="pregunta4" type="text" minlength="2" name="respuesta4" class="form-control" placeholder="Structured Query Language" required></>
            </p>
            <p>
                <label for="pregunta5">Opcion 5</label>
                <input id="opcion5" name="opcion" type="radio" value="rbipeliculas"><input id="pregunta5" type="text" minlength="2" name="respuesta5" class="form-control" placeholder="Structured Query Language" required></>
            <p>
